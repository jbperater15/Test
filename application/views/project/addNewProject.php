                    ...
                    <form role="form" id="addUser" action="<?php echo base_url() ?>addNewUser" method="post" role="form">
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">                                
                                    <div class="form-group">
                                        <label for="fname">Project Code</label>
                                        <input type="text" class="form-control required" id="code" name="code" maxlength="128">
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="password">Year Approved</label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="password">Project Duration From </label>
                                        <input type="date" class="form-control input-sm date-picker" id="password" name="password" maxlength="20">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="cpassword">Project Duration To </label>
                                        <input type="date" class="form-control input-sm date-picker" id="cpassword" name="cpassword" maxlength="20">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="password">Collaborating Agency</label>
                                        <input type="password" class="form-control required" id="password" name="password" maxlength="20">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="cpassword">Beneficiries</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form">
                                        <label for="cpassword">Province</label>
                                        <input type="password" class="form-control required equalTo" id="cpassword" name="cpassword" maxlength="20">
                                    </div>
                                </div>
                                <div class="col-md-4">
